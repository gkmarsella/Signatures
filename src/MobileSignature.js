    ...
    let htmlSignature = `${first}${second}${third}${fourth}${isaLine}${additionalLine}${logo}${statement}${icons}${disclosure}`;
      ...
      return (
        ...
        <CopyToClipboard text={htmlSignature}
          ...
          <button type="button" className={ `btn eci-button ${this.props.isEnabled ? null : 'disabled'}`} tabIndex={this.props.isEnabled ? 0 : -1} onClick={this.handleClickShowAlert.bind(this)} data-container="body" data-toggle="popover" data-placement="top" data-content="Copied to clipboard!">        <svg className="bi bi-phone" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
