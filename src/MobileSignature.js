...
class MobileSignature extends Component {
  ...
  render(){
    ...
    let htmlSignature = `${first}${second}${isaLine}${additionalLine}${logo}${statement}${icons}${disclosure}`;
      
      return (
        <div>
        <CopyToClipboard text={htmlSignature}
          onCopy={() => this.setState({copied: true})}>
          <button type="button" className="btn eci-button" onClick={this.handleClickShowAlert.bind(this)} data-container="body" data-toggle="popover" data-placement="top" data-content="Copied to clipboard!">        <svg className="bi bi-phone" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg> Copy signature for iOS</button>
        </CopyToClipboard>
