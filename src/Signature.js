...
class Signature extends Component {
  render() {
    ...
    return (
      <div>
        <p className="signature-line">
          <strong><span style={{ color: '#00703E' }}>{this.props.name}</span></strong>
